using ExtendingAspNetIdentity.WebUI.IdentityConfig.IdentityServices;
...
namespace ExtendingAspNetIdentity.WebUI.IdentityConfig.IdentityManagers
{
    ...
    public class CustomApplicationUserManager : UserManager<CustomUser, int>
    {
        public CustomApplicationUserManager(IUserStore<CustomUser, int> store)
            : base(store)
        {
        }
        ...
        {
            var manager = new CustomApplicationUserManager(new CustomUserStore(context.Get<CustomApplicationDbContext>()));
