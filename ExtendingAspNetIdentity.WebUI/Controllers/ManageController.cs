...
namespace ExtendingAspNetIdentity.WebUI.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ManageController(CustomApplicationUserManager userManager, CustomApplicationSignInManager signInManager)
        {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var model = new IndexViewModel
            {
                ...
                //Note: string is being passed as a parameter for TwoFactorBrowserRememberedAsync, check if there is generic argument for this using int
